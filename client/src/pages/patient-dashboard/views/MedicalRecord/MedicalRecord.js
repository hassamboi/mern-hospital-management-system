    ...
    <>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        ...
        <TableCell align="right" component="th" scope="row">
          {record.appointment_details.clinicNumber}
        </TableCell>
      </TableRow>
      <TableRow>
              ...
              <Table size="small" aria-label="purchases" sx={{ mb: 5 }}>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="left">{record.appointment_details.date}</TableCell>
              ...
              <Table size="small" aria-label="purchases" sx={{ mb: 5 }}>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="left">{record.prescription.date}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </Box>
              ...
              <Table size="small" aria-label="purchases" sx={{ mb: 5 }}>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="left">{record.payment_details.issue_date}</TableCell>
                    <TableCell align="left">{record.payment_details.due_date}</TableCell>
